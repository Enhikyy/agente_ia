...
class NovaPack {
  ...
  static NovaPack parse(List<int> bytes) {
    ...
    if (id is! String || !RegExp(r'^[a-z0-9][a-z0-9._-]{2,63}$').hasMatch(id) ||
      ...
      throw const FormatException('Metadados ou documentos inválidos');
    }
    return NovaPack(id, name, description, List<String>.from(raw));
  }
}
