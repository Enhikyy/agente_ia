...
class NovaResearchCurriculum {
  ...
  static const postgraduate = <String>['algoritmos e estruturas de dados', 'análise de complexidade', 'compiladores e teoria dos tipos', 'sistemas operacionais e concorrência', 'testes formais e verificação', 'otimização combinatória e convexa', 'otimização bayesiana', 'aprendizado por reforço', 'aprendizado contínuo', 'hipóteses científicas e reprodutibilidade', 'desenho experimental e estatística', 'eficiência energética', 'segurança e isolamento de agentes'];
